...
/**
 * @ClassName TestCopyFile
 * @Description TODO  在控制台录入文件的路径,将文件拷贝到当前项目下
 * @Author admin
...
public class TestCopyFile {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedOutputStream bos = new BufferedOutputStream(new FileOutputStream(file.getName())); //拷贝到当前项目下，文件名不变
